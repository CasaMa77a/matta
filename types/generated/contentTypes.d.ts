...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    bio_eng: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    nome_eng: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiImageryImagery extends Struct.CollectionTypeSchema {
  collectionName: 'imageries';
  info: {
    displayName: 'imagery';
    pluralName: 'imageries';
    singularName: 'imagery';
  };
  options: {
    draftAndPublish: true;
  };
